...
const url = 'mongodb+srv://wgreen24:dbuserpass@whittengreengoodbank.n5sbo25.mongodb.net/WhittenGreenGoodBank?retryWrites=true&w=majority';
let db = null;

MongoClient.connect(url, {useUnifiedTopology: true}, function(err, client) {
    console.log('Connected successfully to db server');

    db = client.db('WhittenGreenGoodBank');
});
